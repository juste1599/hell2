...
@section('turinys')
    <ul class="col-md-6">
        <h4 style="margin-left: 15px;color: white">Rasti užsakymai:</h4>
        @include('ordersearch')

    @if($asUZ === null)
        <p style="margin-left: 15px;color: white; padding-top: 10px">Nerasta užsakymo.</p>
    @else
            ...
            <div class="col-lg-8 offset-lg-1" style="padding-top: 20px">
                <table class="table table-hover table-condensed">
                    ...
                    <tr style="border-bottom: 0px; color: white">
                        ...
                        <th style="width:15%;border-bottom: 10px;">Klientas</th>
                    ...
                    <tr>
                        ...
                        <td width="50"><a onclick="return confirm('Ar tikrai norite pašalinti šį užsakymą?')" href="{{route('adminRoutes.deleteOrder', $asUZ->id_uzsakymas)}}"><button class="button" type="delete"><svg class="bi bi-x-square-fill" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
